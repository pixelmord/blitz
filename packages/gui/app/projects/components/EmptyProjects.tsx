export const EmptyProjects = () => (
  <div className="relative flex flex-col items-center px-4 py-6 sm:px-6">
    <h3 className="text-lg font-medium leading-6">It’s looking empty in here.</h3>
    <p className="max-w-2xl mt-1 text-sm leading-5 text-gray-500"> Why not try creating a project!</p>
    <svg
      className="absolute inset-x-auto hidden ml-48 -mt-4 transform rotate-90 sm:block"
      width={30}
      height={75}
      viewBox="0 0 24 60"
